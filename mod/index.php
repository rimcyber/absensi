...
<head>
    ...
    <meta name="keywords"
        content="absensi kpu batu bara, aplikasi absensi, aplikasi absensi kpu batu bara, sistem absensi kpu batu bara, absensi kpu batu bara" />
                    ...
                    <div class="row h-100 justify-content-center align-items-center">
                        <div class="col-lg-5">
                            <div class="hero-content text-center text-white">
                                <p>
                                    <img src="<?php echo $site_url; ?>/content/logo/logokpu.png" class="img-fluid"
                                        width="180px">
                                </p>
                                <h1 class="text-white"><?php echo $site_name; ?></h1>
                                <p>
                                    <a href="<?php echo $site_url; ?>/login" class="btn btn-primary"><i
                                            aria-hidden="true" class="fa fa-sign-in-alt"></i> MASUK</a>
                                    <!-- <a href="<?php echo $site_url; ?>/registrasi" class="btn btn-primary"><i
                                            aria-hidden="true" class="fa fa-user-plus"></i> DAFTAR</a> -->
                                </p>
                                <i aria-hidden="true" class="fa fa-check-circle"></i> Powered by PT. FLEXI ANUGRAH
                                MANDIRI
                            </div>
                        </div>
                    </div>
